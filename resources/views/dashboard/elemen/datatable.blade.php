    ...
    function getData() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const deleteRoute = '{{ route("elemen.destroy", [":uuid"]) }}';
                const listKriteriaUnjukKerjaRoute = '{{ route("kriteriaUnjukKerja.listByUuid", [":uuid"]) }}';
                const editRoute = '{{ route("elemen.edit", [":uuid"]) }}';
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            render: function(data) {
                                ...
                                const listKriteriaUnjukKerjaRouteRendered = listKriteriaUnjukKerjaRoute.replace(':uuid', data);
                                const editRouteRendered = editRoute.replace(':uuid', data);

                                return `
                                    <ul class="table-controls">
                                        <li onclick="handleListKriteriaUnjukKerja(this)" data-modal="modal-list-kriteriaUnjukKerja" data-route="${listKriteriaUnjukKerjaRouteRendered}" data-elemenName="${elemenName}">
