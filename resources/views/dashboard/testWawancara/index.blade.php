...
@section('title','Kelola Ujian Wawancara')
@section('content')
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-testWawancara" onclick="modalFormCreate(this)">
            ...
            @include('dashboard.testWawancara.create')
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="table-testWawancara" class="table style-3 table-hover" data-route="{{ route('ujianWawancara.datatable') }}">
                        <thead>
                            <tr>
                                <th>Pertanyaan</th>
                                <th>Unjuk Kerja</th>
    ...
    @push('datatable')
        @include('dashboard.testWawancara.component')
        @include('dashboard.testWawancara.datatable')
        @include('dashboard.testWawancara.edit')
    @endpush
@endsection
