    ...
    <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item dropdown">
                        ...
                        <div class="dropdown-menu right" aria-labelledby="pendingTask" style="will-change: transform; position: absolute; transform: translate3d(105px, 0, 0px); top: 0px; left: 0px;">
                            <a class="dropdown-item" href="{{ route('asesi.index') }}">Asesi</a>
                        </div>
                    </li>
        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-asesor" onclick="modalFormCreate(this)">
            ...
            @include('dashboard.asesor.create')
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="table-asesor" class="table style-3 table-hover" data-route="{{ route('asesor.datatable') }}">
                        <thead>
                            <tr>
                    ...
                    @include('dashboard.asesor.modalPersetujuanAssesmen')
                </div>
            </div>
        </div>
    </div>
    @push('datatable')
        @include('dashboard.asesor.component')
        @include('dashboard.asesor.datatable')
        @include('dashboard.asesor.listPersetujuanAssesmen')
        @include('dashboard.asesor.edit')
    @endpush
@endsection
