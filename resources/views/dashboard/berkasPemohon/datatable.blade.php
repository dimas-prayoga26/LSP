<script>
    function getData() {
        const table = $('#table-berkasPemohon');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const deleteRoute = '{{ route("berkasPemohon.destroy", [":uuid"]) }}';
                const editRoute = '{{ route("berkasPemohon.edit", [":uuid"]) }}';

                let berkasPemohonName = '';
                table.DataTable({
                    ...
                    "columns": [
                        {
                            ...
                            render: function(data) {
                                berkasPemohonName = data;
                                return berkasPemohonName;
                            }
                        },
                        {
                            data: 'skema',
                                ...
                                return `
                                    <ul class="table-controls">
                                        <li onclick="handleEdit(this)" data-route="${editRouteRendered}" data-uuid="${data}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="Edit Berkas">
                                        ...
                                        <li onclick="handleDelete(this)" data-route="${deleteRouteRendered}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="Delete Berkas">
