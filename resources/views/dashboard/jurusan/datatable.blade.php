    ...
    function getData() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const deleteRoute = '{{ route("jurusan.destroy", [":uuid"]) }}';
                const listKelasRoute = '{{ route("kelas.listByUuid", [":uuid"]) }}';
                const editRoute = '{{ route("jurusan.edit", [":uuid"]) }}';
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            render: function(data) {
                                ...
                                const listKelasRouteRendered = listKelasRoute.replace(':uuid', data);
                                const editRouteRendered = editRoute.replace(':uuid', data);

                                return `
                                    <ul class="table-controls">
                                        <li onclick="handleListKelas(this)" data-modal="modal-list-kelas" data-route="${listKelasRouteRendered}" data-jurusanName="${jurusanName}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="List Kelas">
                                        ...
                                        <li onclick="handleEdit(this)" data-route="${editRouteRendered}" data-uuid="${data}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="Edit Jurusan">
                                        ...
                                        <li onclick="handleDelete(this)" data-route="${deleteRouteRendered}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="Delete Jurusan">
