...
! function(a, b) {
    ...
    function D(a, b, c) {
        if (b.enablePagination) {
            var d = a.find(".actions button[id='btn-form']").parent(),
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            ...
            if (b.enableFinishButton) {
                f += '<li><button type="submit" class="btn btn-sm btn-primary" id="btn-form" style="font-size:13px !important;" role="menuitem">{0}</button></li>'.format(b.labels.finish);
            }
